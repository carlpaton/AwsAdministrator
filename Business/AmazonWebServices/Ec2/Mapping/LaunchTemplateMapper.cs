...
namespace Business.AmazonWebServices.Ec2.Mapping
{
    public class LaunchTemplateMapper : ILaunchTemplateMapper
    {
        ...
        /// <summary>
        /// This could be changed to check for the `Business.AmazonWebServices.Ec2.Model.VolumeType -> Gp2` first and then map based on a manual `if this, return this`
